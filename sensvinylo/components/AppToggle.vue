...
<template>
    <article class="flex flex-col">
      <span class="text-lg font-bold flex border-b-2 justify-between md:text-xl">{{ props.toggleTitle }}
        ...
        <div v-if="isToggleOpen">
            <p class="text-justify p-4 pt-0 md:text-lg">
