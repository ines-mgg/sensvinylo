...
<template>
    <section class="flex flex-col px-3 mb-6">
        <span class="flex justify-between text-lg font-bold border-b-2"> 
            {{ props.toggleTitle }}
        ...
        <div v-if="isToggleOpen" class="custom-list flex flex-col pl-7 items-start">
