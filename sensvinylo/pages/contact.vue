...
<template>
    ...
    <!-- <section class="flex flex-col items-center my-4 px-2">
        <span class="px-3">Nous sommes également présents sur les réseaux sociaux</span>
        <aside class="px-3">
            <a href="http://"></a> // Facebook
            <a href="http://"></a> // Instagram
            <a href="http://"></a> // Twitter
        </aside>
        <span class="px-3">N'hésitez pas à nous suivre pour être au courant de nos dernières actualités et promotions.</span>
    </section> -->
</template>