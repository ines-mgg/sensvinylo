...
const description = "Sensvinylo, le paradis des vinyles à Paris et en Ile-de-France. Découvrez notre large choix de vinyles neufs et d'occasion, tous styles confondus. Les vinyles de vos artistes préférés en exclusivité chez Sensvinylo.";
getSeoMeta(title, description);

const vinyls = ref<Vinyl[]>([])
onMounted(async () => {
  try {
    vinyls.value = await getFirstVinyls();
    useSchemaOrg([
      getDefinedPage(
      ...
      getDefinedItemList(vinyls.value),
    ])
  } catch (error) {
